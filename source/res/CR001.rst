...
#. Un certain nombre de contraintes techniques ont été déjà mentionnées : les développements devront se faire en JAVA avec le framework Spring v5.
#. Le choix de JAVA/Spring est lié au fait que AccessIT utilise déjà ces technologies en interne.
