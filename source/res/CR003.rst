...
#. L'EHPAD Rives de Seine à Neuilly est bâti suivant le plan général des EHPAD de Ryokan et peur servir d'exemple pour les autre EHPAD de l'entreprise.
...
#. - l'accès au bâtiment se fait après contrôle de la température corporelle et sans identification physique à la seconde porte. Une identification de la proximité du badge d'accès suffira.
#. - l'accès aux pièces à l'intérieur de l'EHPAD (salles, chambres, bureaux, cuisine, locaux techniques, ..) se fera par de simples portes à contrôle d'accès, sans nécessairement enregistrer les passages. La sortie sera libre, sans contrôle.
