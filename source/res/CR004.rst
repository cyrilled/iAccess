...
#. Les lecteurs sont équipés de trois leds (une rouge, une orange et une verte).
...
#. Cette identification physique se fait à l'intérieur du sas, après l'identification par badge à l'entrée.
