...
#. Un certain nombre de contraintes techniques ont été déjà mentionnées : les développements devront se faire en Angular pour le frontend, J2AA pour le backend avec un SGBD Oracle.
